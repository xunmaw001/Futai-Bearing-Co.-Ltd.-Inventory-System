    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='kehu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="客户住址" prop="kehuZhuzhi">
                        <el-input v-model="kehuForm.kehuZhuzhi"
                                  placeholder="客户住址" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="客户住址" prop="kehuZhuzhi">
                            <el-input v-model="ruleForm.kehuZhuzhi"
                                      placeholder="客户住址" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='kehu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="客户来源" prop="laiyuanValue">
                        <el-input v-model="kehuForm.laiyuanValue"
                                  placeholder="客户来源" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="客户来源" prop="laiyuanValue">
                            <el-input v-model="ruleForm.laiyuanValue"
                                      placeholder="客户来源" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='kehu' ">
                ...
                <el-col :span="12"  v-if="sessionTable !='shangpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="售价" prop="shangpinOldMoney">
                        <el-input v-model="shangpinForm.shangpinOldMoney"
                                  placeholder="售价" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="售价" prop="shangpinOldMoney">
                ...
                <el-col :span="12"  v-if="sessionTable !='shangpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="仓库" prop="cangkuValue">
                        <el-input v-model="shangpinForm.cangkuValue"
                ...
                <el-col :span="12"  v-if="sessionTable !='shangpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="到期时间" prop="daoqiTime">
                        <el-input v-model="shangpinForm.daoqiTime"
                                  placeholder="到期时间" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="到期时间" prop="daoqiTime">
                            <el-input v-model="ruleForm.daoqiTime"
                                      placeholder="到期时间" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='xiaoshourenyuan'">
                    <el-form-item class="select" v-if="type!='info'"  label="销售人员" prop="xiaoshourenyuanId">
                        <el-select v-model="ruleForm.xiaoshourenyuanId" :disabled="ro.xiaoshourenyuanId" filterable placeholder="请选择销售人员" @change="xiaoshourenyuanChange">
                            <el-option
                                    v-for="(item,index) in xiaoshourenyuanOptions"
                                    v-bind:key="item.id"
                                    :label="item.xiaoshourenyuanName"
                                    :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='xiaoshourenyuan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="销售人员姓名" prop="xiaoshourenyuanName">
                        <el-input v-model="xiaoshourenyuanForm.xiaoshourenyuanName"
                                  placeholder="销售人员姓名" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="销售人员姓名" prop="xiaoshourenyuanName">
                            <el-input v-model="ruleForm.xiaoshourenyuanName"
                                      placeholder="销售人员姓名" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='xiaoshourenyuan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="销售人员手机号" prop="xiaoshourenyuanPhone">
                        <el-input v-model="xiaoshourenyuanForm.xiaoshourenyuanPhone"
                                  placeholder="销售人员手机号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="销售人员手机号" prop="xiaoshourenyuanPhone">
                            <el-input v-model="ruleForm.xiaoshourenyuanPhone"
                                      placeholder="销售人员手机号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='xiaoshourenyuan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="销售人员身份证号" prop="xiaoshourenyuanIdNumber">
                        <el-input v-model="xiaoshourenyuanForm.xiaoshourenyuanIdNumber"
                                  placeholder="销售人员身份证号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="销售人员身份证号" prop="xiaoshourenyuanIdNumber">
                            <el-input v-model="ruleForm.xiaoshourenyuanIdNumber"
                                      placeholder="销售人员身份证号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12" v-if="sessionTable !='xiaoshourenyuan' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.xiaoshourenyuanPhoto" label="销售人员照片" prop="xiaoshourenyuanPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (xiaoshourenyuanForm.xiaoshourenyuanPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.xiaoshourenyuanPhoto" label="销售人员照片" prop="xiaoshourenyuanPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.xiaoshourenyuanPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='xiaoshourenyuan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="现住址" prop="xiaoshourenyuanZhuzhi">
                        <el-input v-model="xiaoshourenyuanForm.xiaoshourenyuanZhuzhi"
                                  placeholder="现住址" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="现住址" prop="xiaoshourenyuanZhuzhi">
                            <el-input v-model="ruleForm.xiaoshourenyuanZhuzhi"
                                      placeholder="现住址" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='xiaoshourenyuan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="电子邮箱" prop="xiaoshourenyuanEmail">
                        <el-input v-model="xiaoshourenyuanForm.xiaoshourenyuanEmail"
                                  placeholder="电子邮箱" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="电子邮箱" prop="xiaoshourenyuanEmail">
                            <el-input v-model="ruleForm.xiaoshourenyuanEmail"
            ...
            <input id="xiaoshourenyuanId" name="xiaoshourenyuanId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="销售编号" prop="shangpinxiaoshouUuidNumber">
                       <el-input v-model="ruleForm.shangpinxiaoshouUuidNumber"
                                 placeholder="销售编号" clearable  :readonly="ro.shangpinxiaoshouUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="销售编号" prop="shangpinxiaoshouUuidNumber">
                           <el-input v-model="ruleForm.shangpinxiaoshouUuidNumber"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="销售标题" prop="shangpinxiaoshouName">
                       <el-input v-model="ruleForm.shangpinxiaoshouName"
                                 placeholder="销售标题" clearable  :readonly="ro.shangpinxiaoshouName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="销售标题" prop="shangpinxiaoshouName">
                           <el-input v-model="ruleForm.shangpinxiaoshouName"
                                     placeholder="销售标题" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="销售数量" prop="caozuoNumber">
                       <el-input v-model="ruleForm.caozuoNumber"
                                 placeholder="销售数量" clearable  :readonly="ro.caozuoNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="销售数量" prop="caozuoNumber">
                           <el-input v-model="ruleForm.caozuoNumber"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="钱款结清" prop="jieqingTypes">
                        <el-select v-model="ruleForm.jieqingTypes" :disabled="ro.jieqingTypes" placeholder="请选择钱款结清">
                            <el-option
                                v-for="(item,index) in jieqingTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="钱款结清" prop="jieqingValue">
                        <el-input v-model="ruleForm.jieqingValue"
                            placeholder="钱款结清" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12" v-if="type=='info'">
                   <div>
                       <el-form-item class="input" label="销售金额" prop="huafeiMoney">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="shangpinxiaoshouContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.shangpinxiaoshouContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.shangpinxiaoshouContent" label="备注" prop="shangpinxiaoshouContent">
                            <span v-html="ruleForm.shangpinxiaoshouContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    shangpinId: false,
                    kehuId: false,
                    xiaoshourenyuanId: false,
                    shangpinxiaoshouUuidNumber: false,
                    shangpinxiaoshouName: false,
                    caozuoNumber: false,
                    jieqingTypes: false,
                    huafeiMoney: false,
                    xiaoshouTime: false,
                    shangpinxiaoshouContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    shangpinId: '',
                    kehuId: '',
                    xiaoshourenyuanId: '',
                    shangpinxiaoshouUuidNumber: new Date().getTime(),
                    shangpinxiaoshouName: '',
                    caozuoNumber: '',
                    jieqingTypes: '',
                    huafeiMoney: '',
                    xiaoshouTime: '',
                    shangpinxiaoshouContent: '',
                    insertTime: '',
                },
                jieqingTypesOptions : [],
                kehuOptions : [],
                shangpinOptions : [],
                xiaoshourenyuanOptions : [],
                rules: {
                   shangpinId: [
                   ...
                   jieqingTypes: [
                              { required: true, message: '钱款结清不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=jieqing_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.jieqingTypesOptions = data.data.list;
                    }
                });
         ...
         this.$http({
             url: `xiaoshourenyuan/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.xiaoshourenyuanOptions = data.data.list;
            }
         });
        ...
        methods: {
            ...
            xiaoshourenyuanChange(id){
                this.$http({
                    url: `xiaoshourenyuan/info/`+id,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.xiaoshourenyuanForm = data.data;
                    }
                });
            },
            // 多级联动参数
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.xiaoshourenyuanChange(data.data.xiaoshourenyuanId)
                        _this.ruleForm.shangpinxiaoshouContent = _this.ruleForm.shangpinxiaoshouContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.shangpinxiaoshouContent = this.ruleForm.shangpinxiaoshouContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`shangpinxiaoshou/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.shangpinxiaoshouCrossAddOrUpdateFlag = false;
                                        this.parent.search();
