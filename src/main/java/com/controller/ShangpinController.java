...
//                            shangpinEntity.setShangpinDanwei(data.get(0));                    //单位 要改的
...
//                            shangpinEntity.setShangpinNewMoney(data.get(0));                    //进价 要改的
//                            shangpinEntity.setShangpinOldMoney(data.get(0));                    //售价 要改的
//                            shangpinEntity.setCangkuTypes(Integer.valueOf(data.get(0)));   //仓库 要改的
//                            shangpinEntity.setDaoqiTime(sdf.parse(data.get(0)));          //到期时间 要改的
